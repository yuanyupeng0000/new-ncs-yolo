...
void hisi_3519av100_nnie_init_yolov3(void)
{
    ...
    SAMPLE_SVP_TRACE_INFO("Tiny Yolov3 parameter initialization!\n");
    s_stTinyYolov3NnieParam.pstModel = &s_stTinyYolov3Model.stModel;
    s32Ret = SAMPLE_SVP_NNIE_Yolov3_ParamInit(&stNnieCfg,&s_stTinyYolov3NnieParam,&s_stYolov3SoftwareParam);
    SAMPLE_SVP_CHECK_EXPR_GOTO(HI_SUCCESS != s32Ret,TINY_YOLOV3_FAIL_0,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error,SAMPLE_SVP_NNIE_Tiny_Yolov3_ParamInit failed!\n");
    return;
TINY_YOLOV3_FAIL_0:
    SAMPLE_SVP_NNIE_Yolov3_Deinit(&s_stTinyYolov3NnieParam,&s_stYolov3SoftwareParam,&s_stTinyYolov3Model);
    SAMPLE_COMM_SVP_CheckSysExit();
}
...
void hisi_3519av100_nnie_detect_yolov3(void){
    ...
    /*if user has changed net struct, please make sure SAMPLE_SVP_NNIE_Yolov2_GetResult
     function input datas are correct*/
    SAMPLE_SVP_NNIE_PERF_STAT_BEGIN()
    s32Ret = SAMPLE_SVP_NNIE_Yolov3_GetResult(&s_stTinyYolov3NnieParam,&s_stYolov3SoftwareParam);
    SAMPLE_SVP_CHECK_EXPR_GOTO(HI_SUCCESS != s32Ret,TINY_YOLOV3_FAIL_0,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error,SAMPLE_SVP_NNIE_Tiny_Yolov3_GetResult failed!\n");
    SAMPLE_SVP_NNIE_PERF_STAT_END()
    SAMPLE_SVP_NNIE_PERF_STAT_YOLOV2_GR_OP_TIME()
...
******************************************************************************/
void SAMPLE_SVP_NNIE_YOLOV3_TINY_LOOP_SPLIT(void)
{
...
******************************************************************************/
void SAMPLE_SVP_NNIE_YOLOV3_LOOP_SPLIT(void)
{
