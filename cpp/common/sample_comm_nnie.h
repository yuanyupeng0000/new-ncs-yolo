...
typedef struct hiSAMPLE_SVP_NNIE_TINY_YOLOV3_SOFTWARE_PARAM_S
{
    HI_U32 u32OriImHeight;
    HI_U32 u32OriImWidth;
    HI_U32 u32BboxNumEachGrid;
    ...
    HI_U32 u32GridNumHeight;
    HI_U32 u32GridNumWidth;
    HI_U32 u32GridNumHeightArray[2];
    HI_U32 u32GridNumWidthArray[2];
    HI_U32 u32NmsThresh;
    HI_U32 u32ConfThresh;
    HI_U32 u32MaxRoiNum;
    HI_FLOAT af32Bias2[6];
    HI_FLOAT af32Bias1[6];
    HI_FLOAT af32Bias[2][6];
    SVP_MEM_INFO_S stGetResultTmpBuf;
    SVP_DST_BLOB_S stClassRoiNum;
    SVP_DST_BLOB_S stDstRoi;
    SVP_DST_BLOB_S stDstScore;
}SAMPLE_SVP_NNIE_TINY_YOLOV3_SOFTWARE_PARAM_S;
...
typedef struct hiSAMPLE_SVP_NNIE_YOLOV3_SOFTWARE_PARAM_S
{
    ...
    HI_U32 u32BboxNumEachGrid;
    HI_U32 u32ClassNum;
    HI_U32 u32GridNumHeight[3];
    HI_U32 u32GridNumWidth[3];
    HI_U32 u32NmsThresh;
    HI_U32 u32ConfThresh;
    HI_U32 u32MaxRoiNum;
