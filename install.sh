...
echo "change config"
sudo sed -i '/"total_device_num":            8/s/8/1/g' /opt/intel/computer_vision_sdk_2018.5.445/deployment_tools/inference_engine/external/hddl/config/hddl_autoboot.config
...
sudo mv /opt/intel/computer_vision_sdk_2018.5.445/python/python3.5/cv2.cpython-35m-x86_64-linux-gnu.so /opt/intel/computer_vision_sdk_2018.5.445/python/python3.5/cv2.cpython-35m-x86_64-linux-gnu.so.bak
echo "Done!"
